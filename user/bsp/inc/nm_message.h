...
typedef struct tag_PannelMessage_s
{
	int w_index;
	unsigned char syn_head[4];
	unsigned int msg_len;
	unsigned char msg[PANNEL_MSG_MAX_LEN+1];
	unsigned char syn_state;
	unsigned char available;
}PannelMessage, *pPannelMessage;

extern PannelMessage PMessage;
