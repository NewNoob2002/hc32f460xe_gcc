...
typedef struct _SEMP_PARSE_STATE
{
    ...
    SEMP_PRINTF_CALLBACK printError;             // Class to use for error output
    SEMP_PRINTF_CALLBACK printDebug;             // Class to use for debug output
...
SEMP_PARSE_STATE * sempBeginParser(const SEMP_PARSE_ROUTINE *parseTable, \
                                   ...
                                   const char *name, \
                                   SEMP_PRINTF_CALLBACK printError = (SEMP_PRINTF_CALLBACK)nullptr,
                                   SEMP_PRINTF_CALLBACK printDebug = (SEMP_PRINTF_CALLBACK)nullptr,
...
void sempPrintParserConfiguration(SEMP_PARSE_STATE *parse, SEMP_PRINTF_CALLBACK print = (SEMP_PRINTF_CALLBACK)nullptr);
...
void sempEnableDebugOutput(SEMP_PARSE_STATE *parse, SEMP_PRINTF_CALLBACK print = (SEMP_PRINTF_CALLBACK)nullptr);
void sempDisableDebugOutput(SEMP_PARSE_STATE *parse);

// Enable or disable error output
void sempEnableErrorOutput(SEMP_PARSE_STATE *parse, SEMP_PRINTF_CALLBACK print = (SEMP_PRINTF_CALLBACK)nullptr);
